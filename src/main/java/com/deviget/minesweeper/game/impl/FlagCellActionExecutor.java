...
@Component
class FlagCellActionExecutor extends ActionExecutor {

    public FlagCellActionExecutor(GameRepository gameRepository) {
        super(gameRepository);
    }

    public Game doExecute(Game game, int r, int c) {
